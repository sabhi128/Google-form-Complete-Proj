...
export default function Responses() {
  ...
  // Example: hardcoded formId, replace with actual selected formId from your app
  const formId = ""; // TODO: get selected formId from props or context
  ...
  // Example: map backend responses to chart data
  const questionTypesData = [
    { name: 'shortText', value: responses.length },
    { name: 'multipleChoice', value: 0 },
