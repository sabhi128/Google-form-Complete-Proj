...
const DropdownComponent = ({ id, placeholder, options = [], onCopy, onDelete }) => {
  // Persistent states
  ...
  return (
    <div className={`space-y-4 p-4 rounded-lg shadow-md transition-colors duration-300 ${containerBg}`}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <h2 className={`text-xl font-semibold ${labelText}`}>Dropdown</h2>
      ...
      {/* Preview dropdown select box */}
      <div className="mt-4">
        <label className={`block mb-1 ${labelText}`}>Preview:</label>
        <select
          value={selectedValue}
